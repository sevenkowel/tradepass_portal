  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-[var(--tp-border)] bg-transparent text-[var(--tp-fg)] hover:bg-[rgba(var(--tp-fg-rgb),0.05)]",
        secondary:
          "bg-[rgba(var(--tp-fg-rgb),0.08)] text-[var(--tp-fg)] hover:bg-[rgba(var(--tp-fg-rgb),0.12)]",
        ghost:
          "text-[var(--tp-fg)] hover:bg-[rgba(var(--tp-fg-rgb),0.05)]",
        link:
          "text-[var(--tp-primary)] underline-offset-4 hover:underline",
      },
      size: {
